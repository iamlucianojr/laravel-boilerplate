 ...
 * Generated for Laravel 5.2.20 on 2016-05-16.
 *
...
namespace {
    ...
    class LERN extends \Tylercd100\LERN\Facades\LERN{
        
        /**
         * Will execute record and notify methods
         *
         * @param \Tylercd100\LERN\Exception $e The exception to use
         * @return \Tylercd100\LERN\ExceptionModel the recorded Eloquent Model
         * @static 
         */
        public static function handle($e){
            return \Tylercd100\LERN\LERN::handle($e);
        }
        ...
        public static function record($e){
            return \Tylercd100\LERN\LERN::record($e);
        }
        ...
        public static function notify($e){
            \Tylercd100\LERN\LERN::notify($e);
        }
        
        /**
         * Pushes on another Monolog Handler
         *
         * @param \Tylercd100\LERN\HandlerInterface $handler The handler instance to add on
         * @static 
         */
        public static function pushHandler($handler){
            return \Tylercd100\LERN\LERN::pushHandler($handler);
        }
        ...
        public static function getNotifier(){
            return \Tylercd100\LERN\LERN::getNotifier();
        }
        ...
        public static function setNotifier($notifier){
            return \Tylercd100\LERN\LERN::setNotifier($notifier);
        }
         ...
         * @static 
         */
        public static function getRecorder(){
            return \Tylercd100\LERN\LERN::getRecorder();
        }
         ...
         * @static 
         */
        public static function setRecorder($recorder){
            return \Tylercd100\LERN\LERN::setRecorder($recorder);
        }
        
        /**
         * Set a string or a closure to be called that will generate the message body for the notification
         *
         * @param \Tylercd100\LERN\function|string $cb This closure function will be passed an Exception and must return a string
         * @static 
         */
        public static function setMessage($cb){
            return \Tylercd100\LERN\LERN::setMessage($cb);
        }
         ...
         * @static 
         */
        public static function setSubject($cb){
            return \Tylercd100\LERN\LERN::setSubject($cb);
        }
